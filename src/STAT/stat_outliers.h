 ...
 */
stat_size_t stat_count_outliers(const stat_float_t* data, stat_size_t size, 
                               const stat_five_num_summary_t* summary);
...
/**
 * @brief Counts outliers in an array (array version)
 * 
 * @param[in] values Input array of values
 * @param[in] count Number of values in input array
 * @param[in] summary Five-number summary reference
 * @return stat_size_t Count of outliers found
 */
stat_size_t stat_count_outliers_array(const stat_float_t* values, stat_size_t count, const stat_five_num_summary_t* summary);
